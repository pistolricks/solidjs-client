...
const SheetContent = <T extends ValidComponent = "div">(
  ...
  return (
    <SheetPortal position={local.position}>
      ...
      >
        {local.children}
        <SheetPrimitive.CloseButton class="absolute right-4 top-4 rounded-sm opacity-70 outline-offset-background transition-opacity hover:opacity-100 focus:outline-hidden focus:outline-2 focus:outline-ring focus:outline-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary">
          <svg
